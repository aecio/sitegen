  ...
  public void renderPage(Context context, Page page, Path outputFile) throws IOException {
    ...
    switch (contentType.toLowerCase()) {
      ...
      case "markdown":
        ...
        page.content =
            mustache.renderToString(
                context, page.content); // substitute variables even if using markdown template
        break;
      default:
        System.err.println(
            "WARN: Template engine for internal page content not found: " + page.content_type);
    }
